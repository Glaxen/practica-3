                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                {{-- botton de editar --}}
                                <div class="col-6">
                                    <button id="{{$mantenimiento->id}}" type="button" class="btneditbrand btn btn-primary">
                                        <i class="fas fa-solid fa-pen"></i>
                                    </button>
                                </div>
                                {{-- boton de borrar  --}}
                                <div class="col-6">
                                    <form class="frmDelete" action="{{ route('admin.mantenimiento.destroy', $mantenimiento->id) }}" method="post">
                                        @method('delete')
                                        @csrf
